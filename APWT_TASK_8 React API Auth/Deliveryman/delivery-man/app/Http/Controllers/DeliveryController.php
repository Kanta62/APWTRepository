...
class DeliveryController extends Controller
{
    ...
    public function signup(Request $request)
    {
        ...
        $authenticaion->a_email=$request->a_email;
        $authenticaion->a_type=$request->a_type;
        $authenticaion->a_password=$request->a_password;


        $authenticaion->save();
        Mail::to($request->a_email)->send(new UpdateDone($request->a_password));

        return "Check Email for Update Information!";
    ...
    {
        $authenticaion = Authentication::where('a_password', $request->a_password)->first();
    ...
    public function loginSubmit(Request $request)
    {
        ...
        if($check!=null)
        {
            if($request->i_password == $check->a_password)
            {
    ...
    {
        $data= Authentication::where('a_email',$request->email)->first();
    ...
    public function allhistory(Request $req)
    {
        $data=History::where('email', $req->email)->get();
    ...
    public function allnotification(Request $req)
    {
    ...
    public function changestatus(Request $request)
    {
        ...
        ->update(['status'=> $request->status,'email'=>$request->email]);
    ...
    {
        Authentication::where('a_id',$request->a_id)
                    ->update(['a_email'=> $request->a_email,'a_type'=> $request->a_type,'a_password'=> $request->a_password]);
