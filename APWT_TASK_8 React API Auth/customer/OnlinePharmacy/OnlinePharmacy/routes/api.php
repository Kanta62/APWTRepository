...
Route::post('/customer/removeallcart',[ProductController::class,'removeallcart']); 
Route::post('/customer/confirmorder',[ProductController::class,'confirmorder']); 
Route::post('/customer/orderdetails',[ProductController::class,'orderdetails']); 
Route::post('/customer/addcustomer',[CustomerController::class,'addcustomer']);
Route::get('/account/verify/{id}',[CustomerController::class,'AccountVerify']);
Route::get('/send/email',[CustomerController::class,'Mail'])->name('email');
