...
class LoginAPIController extends Controller
{
    ...
    public function APIReg(Request $req){
        ...
        $loginAPI->name = $req->name;
        $loginAPI->prmId = $req->prmId;
        $loginAPI->email = $req->email;
        $loginAPI->dob = $req->dob;
        $loginAPI->username = $req->username;
        $loginAPI->password = $req->password;
        $loginAPI->confirmpass = $req->confirmpass;
        $loginAPI->phone = $req->phone;
        $loginAPI->address = $req->address;
        $loginAPI->save();

        Mail::to($req->email)->send(new RegDone($req->prmId));

        return response()->json([
            'message'=>'Successfully Registered!!  Check Email for Verification!'
        ]);
    ...
    {
        $loginAPI = LoginAPI::where('prmId', $request->id)->first();
        return response()->json([
